export default function LoginPage() {
    return (
        <div className='flex h-screen items-center justify-center overflow-hidden bg-blue-800/70'>
            <div className='md:6/12 shadow-3xl w-10/12 bg-white lg:w-5/12'>
                ...
                <form className='p-12 md:p-24'>
                    ...
                    <button className='w-full bg-gradient-to-b from-gray-700 to-gray-900 p-2 font-medium uppercase text-white md:p-4'>Login</button>
                </form>
            </div>
        </div>
    )
